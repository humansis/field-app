...
interface HumansisService {
    ...
    @GET("v1/distributions/{assistanceId}/beneficiaries")
    suspend fun getDistributionBeneficiaries(@Path("assistanceId") assistanceId: Int): List<DistributionBeneficiary>
